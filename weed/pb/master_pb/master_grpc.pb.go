...
const (
	...
	Seaweed_VolumeServerECoding_FullMethodName    = "/master_pb.Seaweed/VolumeServerECoding"
)
...
type SeaweedClient interface {
	...
	VolumeServerECoding(ctx context.Context, in *VolumeServerECodingRequest, opts ...grpc.CallOption) (*VolumeServerECodingResponse, error)
}
...
func (c *seaweedClient) VolumeServerECoding(ctx context.Context, in *VolumeServerECodingRequest, opts ...grpc.CallOption) (*VolumeServerECodingResponse, error) {
	out := new(VolumeServerECodingResponse)
	err := c.cc.Invoke(ctx, Seaweed_VolumeServerECoding_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SeaweedServer interface {
	...
	VolumeServerECoding(context.Context, *VolumeServerECodingRequest) (*VolumeServerECodingResponse, error)
...
func (UnimplementedSeaweedServer) VolumeServerECoding(context.Context, *VolumeServerECodingRequest) (*VolumeServerECodingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method VolumeServerECoding not implemented")
}
...
func _Seaweed_VolumeServerECoding_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VolumeServerECodingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SeaweedServer).VolumeServerECoding(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Seaweed_VolumeServerECoding_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SeaweedServer).VolumeServerECoding(ctx, req.(*VolumeServerECodingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Seaweed_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VolumeServerECoding",
			Handler:    _Seaweed_VolumeServerECoding_Handler,
		},
	},
